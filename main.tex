...
\begin{table}[h!]
\centering
\begin{tabularx}{\textwidth}{|>{\raggedright\arraybackslash}p{4cm}|*{11}{>{\centering\arraybackslash}X|}}
\hline
\rowcolor{gray!20}
\textbf{ACTIVIDAD} & \textbf{F} & \textbf{M} & \textbf{A} & \textbf{M} & \textbf{J} & \textbf{J} & \textbf{A} & \textbf{S} & \textbf{O} & \textbf{N} & \textbf{D} \\
\hline
Investigación documental & \cellcolor{green!30} & \cellcolor{green!30} & \cellcolor{green!30} & \cellcolor{green!30} & & & & & & & \\
\hline
Pruebas del estado del arte & & \cellcolor{green!30} & \cellcolor{green!30} & \cellcolor{green!30} & & & & & & & \\
\hline
Captura y recolección de datos & & & \cellcolor{green!30} & \cellcolor{green!30} & \cellcolor{gray!30} & & & & & & \\
\hline
Selección de algoritmos a utilizar & & & & \cellcolor{green!30} & \cellcolor{gray!30} & & & & & & \\
\hline
Propuestas de modificaciones & & & & & \cellcolor{gray!30} & \cellcolor{gray!30} & & & & & \\
\hline
Implementación de modificaciones e integración & & & & & \cellcolor{gray!30} & \cellcolor{gray!30} & \cellcolor{gray!30} & & & & \\
\hline
Pruebas y evaluación          & & & & & & & \cellcolor{gray!30} & \cellcolor{gray!30} & & & \\
\hline
Análisis de resultados         & & & & & & & & \cellcolor{gray!30} & \cellcolor{gray!30} & & \\
\hline
Documentación y redacción de reporte técnico & & & & & & & & \cellcolor{gray!30} & \cellcolor{gray!30} & \cellcolor{gray!30} & \cellcolor{gray!30} \\
\hline
\end{tabularx}
\caption{Cronograma de actividades con marcación por mes}
\end{table}
